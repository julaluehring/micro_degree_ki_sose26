...
* **Klassifikation**: Ausgabe ist eine Klasse (z.B. Spam / kein Spam)
  - Naive Bayes, decision tree, random forest, logistic regression, usw. 

* **Regression**: Ausgabe ist ein kontinuierlicher Wert (z.B. Preis)
  - Decision tree, random forest, linear regression, usw. 
...
* **Faustregel**: mit simplen Modellen und Hyperparametern starten, Komplexität bei Bedarf erhöhen und Ergebnisse systematisch evaluieren!
...
* **semi-supervised learning**: wenige Labels, daher lernt das Modell von beidem 

* **self-supervised**: das Modell erstellt eigene Label und lernt dann davon

* **transfer learning**: man nimmt ein vortrainiertes Modell, z.B. ein passendes BERT-Modell von huggingface.com

## Deep Learning und LLMs

* **Deep learning**: unstrukturierte Daten, gut für Bilder und Audio; braucht aber viele Daten, daher oft transfer learning

* **LLMs**: zero- oder few-shot learning (lokal z.B. mit Ollama)
...
Vergleich von kontinuierlicher Vorhersage gegen Klassen

![Luehring et al., [2025](https://doi.org/10.31234/osf.io/cemw7_v1)](images/roc_curve.png){width="500"}

$\rightarrow$ In so einer Grafik kann man auch die Performanz von verschiedenen *Modellen* oder *Hyperparametern* vergleichen
...
## Data & code sharing: best practices

**Daten**: Ggf. anonymisieren und auf europäischen Servern bereitstellen (z.B. OSF)

> Zook et al. ([2017](https://doi.org/10.1371/journal.pcbi.1005399)): Ten rules for responsible big data research 

**Code**: GitHub oder GitLab für version control, Google Colab zum direkten Kollaborieren an Skripten oder auch ein OSF-repository mit Daten und Code

> GitHub Education (mit Copilot) oder Claude Code (in der Konsole)

## Klassische Pipeline

1. Haben wir gelabelte Daten, wie viele und wie gut ist die Qualität?

2. Testen verschiedener Ansätze und Hyperparameter

3. Auswertung dessen, was am besten klappt -- mit Diskussion der Implikationen und Fehler
